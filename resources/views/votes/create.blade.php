        ...
        <div class="col-md-8 offset-md-2">
          ...
          @endif
            ...
            <div class="form-group">
                <input type="text" class="form-control input-lg" id="group_id" name="vote_group" form="form" value="{{$gid}}">
              ...
              <div class="card">
                ...
                <div class="card-body" id="question-area">
                  @if($type > 0)
                    ...
                    <div class="form-group">
                      <textarea class="form-control" rows="3" name="question[{{ $question->id }}][c]" form="form">{{ $question->criteria }}</textarea>
                  ...
                  @else
                  <div class="form-group">
                    <input type="text" class="form-control" name="question[][criteria]" form="form">
                  </div>
                  <hr>
                  @endif
                </div>
...
<script>
    $(document).ready(function (){
      $("#add-question").click(function(){
        $("#question-area").append("<div class='form-group'>    <input type='text' class='form-control' name='question[][criteria]' form='form'>  </div><hr>");
      });
    });
